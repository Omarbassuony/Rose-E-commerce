    ...
    <div className="container mx-auto t-20 mb-10 pt-20 flex items-center justify-between ">
      ...
      <ul className="flex cursor-pointer gap-x-6">
        {categories?.map((cat: Category, index: number) => (
          <li
            className="hover:text-custom-rose-900 duration-300 text-custom-blue-900 font-normal text-lg font-inter me-6"
            key={cat._id}
          >
